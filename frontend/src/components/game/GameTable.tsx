...
export function GameTable({
  ...
  return (
    <div
      className={`felt-table felt-noise relative mx-auto aspect-[16/10] w-full max-w-6xl overflow-hidden rounded-[2rem] border border-gold/30 shadow-2xl sm:rounded-[3rem] ${className}`}
    >
